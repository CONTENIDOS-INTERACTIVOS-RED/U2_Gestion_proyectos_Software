        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La planificación y el control, son pilares esenciales en la gestión de proyectos de #[i software], dado que permiten estructurar el trabajo, asignar recursos de manera eficiente y garantizar el cumplimiento de los objetivos establecidos. En esta unidad, se estudiarán técnicas fundamentales como la estimación de tiempos y costos, el uso de diagramas de Gantt y el seguimiento de KPIs, que facilitan la toma de decisiones informadas, la adaptación a los cambios y la entrega de resultados de calidad.

              p #[b ¡Prepárese para gestionar proyectos de #[i software] con herramientas prácticas, pensamiento estratégico y liderazgo efectivo!]
